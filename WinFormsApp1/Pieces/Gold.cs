...
namespace WinFormsApp1
{
    internal class Gold : Piece
    {
        ...
        {
            // Conditie:
            // Math.abs(x1 - x0) == 1) && (Math.abs(y1 - y0) == 1) && (x1 - x0) == -1
            // ||
            // Math.abs((x1 - x0) - (y1 - y0)) == 1    --- diagonale jos
            ...
            if (this.Color == "W")
            {
                for (int i = iMax; i <= iMin; i++)
                {
                    for (int j = jMax; j <= jMin; j++)
                    {
                        ...
                        if ((i == iMin && j == jMin) || (i == iMin && j == jMax))
                        {
                            valid = false;
                        }
                        if (i == iMin && j == jMin && jMin == coord.Item1)
                        {
                            valid = true;
                        }
                        if (valid == true)
            ...
            else
            {
                for (int i = iMax; i <= iMin; i++)
                {
                    for (int j = jMax; j <= jMin; j++)
                    {
                        ...
                        if ((i == iMax && j == jMin) || (i == iMax && j == jMax))
                        {
                            valid = false;
                        }
                        if (i == iMax && j == jMin && jMin == coord.Item1)
                        {
                            valid = true;
                        }
                        if (valid == true)
